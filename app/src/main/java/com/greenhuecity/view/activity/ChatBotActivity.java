...
import com.greenhuecity.data.model.APIChatBot;
import com.greenhuecity.data.model.Message;
import com.greenhuecity.data.model.MessageAdapter;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    void callAPI(String question){
        // okhttp
        messageList.add(new Message("Đang trả lời...", Message.SEND_BY_BOT));
        ...
        Request request = new Request.Builder()
                .url(APIChatBot.API_URL)
                .header("Authorization","Bearer "+APIChatBot.API)
                .post(requestBody)
                .build();
